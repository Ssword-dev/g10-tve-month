...
const base = TabsPrimitive.Trigger;

type ComponentBase = typeof base;
interface TabsTriggerProps extends Props<ComponentBase>, ClassProps {}

const TabsTrigger = forwardRef<RefType<ComponentBase>, TabsTriggerProps>(
...
export type { TabsTriggerProps as Props };
